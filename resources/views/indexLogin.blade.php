...
<body>
    ...
    <footer class="footer">
        <div class="footer__content">
            <div class="footer__infromation">
                <h4 class="footer__title">
                    О нашем сайте:
                </h4>
                <p class="footer__description">
                    Наш сайт предназначен для абитуриентов Улытауской области, которые ищут колледжи, соответствующие их
                    способностям и интересам. Он помогает студентам подобрать подходящее учебное заведение.
                </p>
            </div>
            <div class="footer__contacts">
                <h4 class="footer__contacts__title">
                    Наши контакты:
                </h4>
                <div class="footer__telephone__wrapper">
                    <img src="assets/icons/Vector.png" alt="" class="telephone-icon">
                    <h5 class="footer__telephone">
                        8 (710) 276 8410
                    </h5>
                </div>
                <div class="footer__telephone__wrapper">
            ...
            <div class="footer__socials">
                <h5 class="footer__socials__title">
                    Наши соц-сети:
                </h5>
                <div class="footer__socials__wrapper">
                    <a href="" class="footer__wrapper-social-link"><svg width="28" height="28"
                            viewBox="0 0 28 28" class="footer__social-icon" fill="none"
                    ...
                    <a href="" class="footer__wrapper-social-link"><svg width="27" height="27"
                            viewBox="0 0 27 27" class="footer__social-icon" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href="" class="footer__wrapper-social-link"><svg width="24" height="24"
                            viewBox="0 0 24 24" class="footer__social-icon" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <h5 class="footer__college">
                    kolledg.kz@mail.ru
                </h5>
            </div>
        </div>
        <div class="sub-footer">
            <h5 class="sub-footer__title">
                Разработчик: <span class="sub-footer__name">Ulytau Team</span>
            </h5>
            <a href="/confidentiality.php" class="sub-footer__confidentiality">
        ...
        <div class="modal-reg__content">
            ...
            <form action={{ route('register') }} class="modal-reg__form" method="post">
                ...
                <div class="form-row">
                    ...
                    <input type="text" class="input__name-reg" name="name" id="input__name-reg">
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="input__email-reg" name="email" class="input__email-reg">
                </div>
                <div class="form-row">
