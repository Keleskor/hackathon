        ...
        <div class="header__wrapper">
            ...
            <ul class="header-list">
                <li class="header-list__element">
                    <a href={{route("index")}} class="header-list__link">
                        Главная
                    </a>
                </li>
                <li class="header-list__element">
                    <a href={{route("CollegeName")}} class="header-list__link">
                        Список <span class="colleges"> колледжей</span>
                    </a>
                </li>
                <li class="header-list__element">
                    <a href={{route("survey")}} class="header-list__link">
                        Опрос
                    </a>
                </li>
                <li class="header-list__element">
                    <a href={{route("contact")}} class="header-list__link">
                        Контакты
                    </a>
                </li>
                <li class="header-list__element">
                    <a href={{route("student")}} class="header-list__link">
                        Интересы студентов
                    </a>
                </li>
            </ul>
